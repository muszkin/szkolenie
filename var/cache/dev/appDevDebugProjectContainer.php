...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['book_listener'] = new \AppBundle\EventListener\BookListener($this->get('debug.event_dispatcher'));
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('hbtAt0Lb7+', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MQx+U+wi4U', 0, 'xrow1eF+Behzm5Osr1JrU7', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventListener(array(0 => 'postPersist'), $this->get('book_listener'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_7c9d13f860b86a1e0636c8a3a517f262739554e07d6aaa0139ea92b4d0b7d5c5');
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('gVvugW1+kq', NULL, 'xrow1eF+Behzm5Osr1JrU7', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pmVgZt1-vl', 0, 'xrow1eF+Behzm5Osr1JrU7', (__DIR__.'/pools'), $this->get('monolog.logger.cache'));
    }

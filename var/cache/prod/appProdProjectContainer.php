...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'book_listener' => 'getBookListenerService',
            ...
            'notification_handler_a' => 'getNotificationHandlerAService',
            'notification_handler_b' => 'getNotificationHandlerBService',
            'order_notification' => 'getOrderNotificationService',
    ...
    /*
     * Gets the 'book_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\EventListener\BookListener A AppBundle\EventListener\BookListener instance
     */
    protected function getBookListenerService()
    {
        return $this->services['book_listener'] = new \AppBundle\EventListener\BookListener($this->get('event_dispatcher'));
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('TeRSN8xsAR', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('UYDeP3MZBy', 0, '5QpP4hLV8Ecr8ZBhPhZsTk', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $a->addEventListener(array(0 => 'postPersist'), $this->get('book_listener'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_36c6be954b14e00672e18c0318870218815719728eeec5fa2bf85e5f8c3dd5fd');
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListenerService('book.new', array(0 => 'order_notification', 1 => 'send'), 0);
    ...
    /*
     * Gets the 'notification_handler_a' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Notification\Handler\NotificationHandlerA A AppBundle\Notification\Handler\NotificationHandlerA instance
     */
    protected function getNotificationHandlerAService()
    {
        return $this->services['notification_handler_a'] = new \AppBundle\Notification\Handler\NotificationHandlerA();
    }

    /*
     * Gets the 'notification_handler_b' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Notification\Handler\NotificationHandlerB A AppBundle\Notification\Handler\NotificationHandlerB instance
     */
    protected function getNotificationHandlerBService()
    {
        return $this->services['notification_handler_b'] = new \AppBundle\Notification\Handler\NotificationHandlerB();
    }

    /*
     * Gets the 'order_notification' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Notification\OrderNotification A AppBundle\Notification\OrderNotification instance
     */
    protected function getOrderNotificationService()
    {
        $this->services['order_notification'] = $instance = new \AppBundle\Notification\OrderNotification();

        $instance->addHandler($this->get('notification_handler_a'));
        $instance->addHandler($this->get('notification_handler_b'));
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('WELB7dZ4rz', NULL, '5QpP4hLV8Ecr8ZBhPhZsTk', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('437984h318f09d1jn32y18ghkjfdsa');
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('HXRsdBDEHa', 0, '5QpP4hLV8Ecr8ZBhPhZsTk', (__DIR__.'/pools'), $this->get('monolog.logger.cache'));
    }
    ...
    {
        return $this->services['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('RPWzC46Hhk', 0, '5QpP4hLV8Ecr8ZBhPhZsTk', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getSecurity_User_Provider_Concrete_InMemoryService()
    {
        ...
        $instance->createUser(new \Symfony\Component\Security\Core\User\User('admin', '$2y$12$eiGiLYqz19xD8vS5/zI0a.DlYMRJoZVmp9pAhti935Sr/tDv7Hk.a', array(0 => 'ROLE_USER')));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '437984h318f09d1jn32y18ghkjfdsa',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '437984h318f09d1jn32y18ghkjfdsa',
